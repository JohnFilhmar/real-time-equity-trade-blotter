  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        onClick={() => set_revealed((current) => !current)}
        className="absolute top-1/2 right-[6px] grid h-[22px] w-[22px] -translate-y-1/2 place-items-center rounded-[5px] text-muted transition-colors hover:bg-glass-soft hover:text-brand-lo focus-visible:outline-2 focus-visible:outline-brand"
      >
