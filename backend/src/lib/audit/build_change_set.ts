 ...
 * recording a server-owned field if one is ever added to the create schema by mistake.
 */
 ...
 * changed one field from producing an audit row claiming it touched eight.
 *
